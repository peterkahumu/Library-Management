...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            cache.clear()
            self.stdout.write(self.style.SUCCESS("Full cache.clear() executed successfully."))
        except Exception as e:
            self.stdout.write(self.style.WARNING(f"Could not perform full cache clear: {e}"))
